...
names(moodleRquizzes)=c("None", "Find mean", "Find Mean and Median", "Confidence Interval for Mean", "Five Number Summary",
                 "One Categorical Variable", "Two Categorical Variables", "Correlation and Regression", "Hypothesis Testing",
                 "Confidence Interval for Percentage", "Sample Size for Proportion",
                 "Precalculus: Solve Linear System", "Calculus: Find Derivatives and Integral", "Refresh Page for New Selection")  
