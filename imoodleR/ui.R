...
Distributions=c("Normal", "Uniform", "Beta", "Gamma", "Categorical Variable", "Bivariate Normal", "R Code")
...
shinyUI(fluidPage(
  ...
  conditionalPanel( condition = "input.dtl == 'Yes'",
      ...
      radioButtons("answertype1", "Type of Answer", choices=c("Numeric Answer", "Multiple Choice", "Numeric Matrix", "Plain Text"), inline = TRUE),
  ...
  conditionalPanel( condition = "input.numquestions > 1", 
      ...
      radioButtons("answertype2", "Type of Answer", choices=c("Numeric Answer", "Multiple Choice", "Plain Text"), inline = TRUE),
  ...
  conditionalPanel( condition = "input.numquestions > 2", 
      ...
      radioButtons("answertype3", "Type of Answer", choices=c("Numeric Answer", "Multiple Choice", "Plain Text"), inline = TRUE),
  ...
  conditionalPanel( condition = "input.numquestions > 3", 
      ...
      radioButtons("answertype4", "Type of Answer", choices=c("Numeric Answer", "Multiple Choice", "Plain Text"), inline = TRUE),
  ...
  conditionalPanel( condition = "input.numquestions > 4", 
        ...
        radioButtons("answertype5", "Type of Answer", choices=c("Numeric Answer", "Multiple Choice", "Plain Text"), inline = TRUE),
